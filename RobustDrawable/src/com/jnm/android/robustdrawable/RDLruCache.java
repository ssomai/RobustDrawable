    			...
    			if (size < 0 || (map.isEmpty() && size != 0)) {
    				...
    				if(maxSize <= 1) {
    					...
    					for(Entry<K, V> e : map.entrySet()) {
    						size += safeSizeOf(e.getKey(), e.getValue());
    					}
    					// throw new IllegalStateException(getClass().getName()+".sizeOf() is reporting inconsistent results! "+size+", "+map.isEmpty());
    				}
    			}
